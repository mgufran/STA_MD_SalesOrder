...
sap.ui.define([
		...
		return BaseController.extend("mg.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("mg.view.ViewSettingsDialog", this);
