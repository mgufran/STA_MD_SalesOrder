sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("mg/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("mg.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["mg/localService/mockserver"], function (mockserver) {
